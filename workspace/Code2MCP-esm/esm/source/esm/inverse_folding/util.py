...
# from biotite.structure import filter_backbone  # 在新版本biotite中不可用
# 定义替代函数
def filter_backbone(structure):
    """
    Filter backbone atoms (N, CA, C, O) from structure
    """
    backbone_atoms = ["N", "CA", "C", "O"]
    return [atom.atom_name in backbone_atoms for atom in structure]
